...
<div id="content">
	<form action="proses/user-input-proses.php" method="post">
	<table id="tabel-input">
		<tr>
			<td class="label-formulir">ID User</td>
			<td class="isian-formulir"><input type="text" name="id_user" class="isian-formulir isian-formulir-border"></td>
		</tr>
		<tr>
