...
$pdf->Image('../images/rumah-baca-logo.jpg',10,8,20,19);
$pdf->Cell(187,6,'Taman Baca Masyarakat Al Iqro',0,1,'C');
$pdf->setFont('Arial','B',8);
$pdf->Cell(187,6,'Jl. Irigasi Kecamatan larangan Kabupaten Brebes, No. HP. 087861832247,0,1,'C');
