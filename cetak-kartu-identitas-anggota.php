...
$pdf->Image('../images/rumah-baca-logo.jpg',10,9,10,10);
$pdf->Image('../images/foto-default.jpg',80,29,20,25);
$pdf->setFont('Arial','B',12);
$pdf->Cell(90,5,'Taman Baca Masyarakat Al Iqro',0,0,'C');
$pdf->Cell(10,5,'',0,0,'C');
$pdf->setFont('Arial','B',10);
$pdf->Cell(90,5,'KETENTUAN',0,1,'C');
$pdf->setFont('Arial','B',6);
$pdf->Cell(90,5,'Jl. Irigasi Kecamatan Larangan Kabupaten Brebes, HP.087861832247',0,0,'C');
$pdf->Cell(10,5,'',0,0,'C');
$pdf->setFont('Arial','',7);
